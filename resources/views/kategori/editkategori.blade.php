			...
			<div class="page-content-wrapper">
				<div class="page-content">
						...
						<div class="ps-3">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb mb-0 p-0">
									<li class="breadcrumb-item"><a href="beranda"><i class='fadeIn animated bx bx-book-alt'></i></a>
									</li>
									<li class="breadcrumb-item active" aria-current="page">KategoriBuku/EditKategori</li>
								</ol>
							</nav>
						</div>
					</div>
                    <div class="card radius-15">
						<div class="card-body">
                            <div class="row">
                                <form action="/editkategoripost/{{$data->id}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text"
                                                ...
                                                id="kategori" name="kategori" value="{{$data->kategori}}">                          
                                        </div>
                                    </div>
