<head>
  ...
  <link rel="stylesheet" href="{{asset('templates/demo/assets/vendor/libs/toastr/toastr.css')}}" />
  <link rel="stylesheet" href="{{asset('templates/demo/assets/vendor/libs/animate-css/animate.css')}}" />
