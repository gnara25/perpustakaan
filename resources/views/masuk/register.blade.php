    ...
    <section id="wrapper">
        ...
        <div class="login-box-bas bag-daftar">
          <div class="login-box card">
              <form accept-charset="UTF-8" role="form" id='xyz' class="form-signin" action="registeruser" method="post" enctype="multipart/form-data">
                @csrf     
                  <h3>Data Diri</h3>   
                 ...
                 <!--  <div class="form-group row">
                  ...
                  <div class="form-group row mb-0">
                      <div class="col-md-6 font-14">
                          <button class="btn btn-info waves-effect waves-light btn-block" type="submit" id='register'>
                              Daftar
                          </button>                                   
                      </div>
                      <div class="col-md-6 font-14">
                          <a href="login" class="btn btn-outline-info waves-effect waves-light btn-block" type="button">
                              Kembali
                          </a>                                 
                      </div>
                  </div>     
