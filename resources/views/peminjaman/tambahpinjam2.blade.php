                    ...
                    <div class="card radius-15">
                        <div class="card-body">
                            <div class="row">
                                <form action="/insert" method="POST" enctype="multipart/form-data" class="form-pinjam">
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" id="nisn" onkeyup="complate()"
                                                class="form-control" value="" name="nisn" required>
                                        ...
                                        <div class="col-sm-5">
                                            <div class="input-group has-validation">
                                                ...
                                                <span class="input-group-btn">
                                                    ...
                                                    <input type="hidden" value="" name="namabuku" id="name">
                            ...
                            <center>
                                <div class="mb-4 mt-4">
                                    <button id="pilihBuku"
                                        class="btn btn-info btn-icon-split col-sm-3 mb-3 pilihBuku">
