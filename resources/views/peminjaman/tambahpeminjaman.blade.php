                  ...
                  <div class="card-body">
                    <form action="/insert" method="POST" enctype="multipart/form-data">
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10"> 
                          <input type="text" name="name" class="form-control" id="basic-default-name" placeholder="Nama Siswa" value="{{ Auth::user()->name }}" readonly>  
                        </div>
                      </div>
                      <div class="row mb-3">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="namabuku" class="form-control" id="basic-default-name" placeholder="Judul Buku" />
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-phone">Tgl.Peminjaman</label>
                        <div class="col-sm-10">
                          <input type="date" name="tanggalpinjam" class="form-control" id="basic-default-name"  />
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-phone">Tgl.Pengembalian</label>
                        <div class="col-sm-10">
                          <input type="date" name="tanggalpengembalian" class="form-control" id="basic-default-name"  />
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="basic-default-phone">Jumlah Buku</label>
                        <div class="col-sm-10">
                          <input type="number" name="jumlah" class="form-control" id="basic-default-name" placeholder="Jumlah Buku" />
                        </div>
                      </div>
