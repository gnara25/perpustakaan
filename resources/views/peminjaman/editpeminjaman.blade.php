                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <option value="{{ $p->id }}"
                                                <?php if ($data->namabuku == $p->id) {
                                                    echo 'selected'; } ?>>{{ $p->namabuku }}</option>
                                            @endforeach
                                            </select>
                                            @error('namabuku')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date"
                                                ...
                                                id="tanggalpinjam" name="tanggalpinjam" value="{{ $data->tanggalpinjam }}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="date"
                                                ...
                                                id="tanggalpengembalian" name="tanggalpengembalian" value="{{ $data->tanggalpengembalian }}" readonly>
